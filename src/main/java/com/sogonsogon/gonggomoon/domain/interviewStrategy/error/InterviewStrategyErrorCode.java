package com.sogonsogon.gonggomoon.domain.interviewStrategy.error;
...
public enum InterviewStrategyErrorCode implements BaseErrorCode {
    ...
    WEEKLY_LIMIT_EXCEEDED("INTERVIEW_STRATEGY_WEEKLY_LIMIT_EXCEEDED", HttpStatus.CONFLICT, "이번 주 면접 질문 생성 가능 횟수를 모두 사용했습니다."),
