...
public class InterviewStrategy {
    ...
    @Column(name = "status")
    private InterviewGenerateStatus status;
    ...
    public static InterviewStrategy create(
        ...
        return InterviewStrategy.builder()
                ...
                .status(InterviewGenerateStatus.PROCESSING)
                .build();
    }
    ...
    public void updateStatusReady() {
        this.status = InterviewGenerateStatus.READY;
    }

    public void updateStateFailed() {
        this.status = InterviewGenerateStatus.FAILED;
    }
